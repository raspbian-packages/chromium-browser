...
static icu::DateFormat* CreateDateTimeFormat(
  ...
  if (Utils::ExtractStringSetting(settings, "skeleton", &skeleton)) {
  ...
  if (Utils::ExtractStringSetting(settings, "dateStyle", &date_style)) {
  ...
  if (Utils::ExtractStringSetting(settings, "timeStyle", &time_style)) {
